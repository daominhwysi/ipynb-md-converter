...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-20 px-6 flex flex-col justify-start items-center">
      <div className="w-full max-w-[600px] flex flex-col space-y-12">
            ...
            <div className="flex items-center justify-between">
              ...
              {uploadedFiles.length > 1 && (
                <button
                  ...
                  className="text-xs text-muted hover:text-foreground flex items-center space-x-1.5 transition-colors cursor-pointer select-none font-medium"
                >
              ...
              {uploadedFiles.map((file) => (
                ...
                >
                  <div className="flex items-center space-x-3 truncate">
                    <FileText className={`h-4 w-4 ${activeFileId === file.id ? 'text-accent' : 'text-muted'}`} />
                    <span className={`text-sm truncate ${activeFileId === file.id ? 'text-foreground' : 'text-muted hover:text-foreground transition-colors'}`}>{file.name}</span>
                  </div>
                  <div className="flex items-center space-x-3 text-xs text-muted shrink-0">
          ...
          <section className="flex flex-col space-y-4 pt-2">
            ...
            <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 border-b border-border pb-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                {/* Accent Button: Only loud element on page */}
                <button
            ...
            <div className="pt-2">
              ...
              {activeTab === 'markdown' && (
                <textarea
                  ...
                  className="w-full h-80 p-4 border border-border rounded-md bg-surface text-xs font-mono resize-none outline-none leading-relaxed overflow-y-auto select-text"
                />
              )}

              {/* Original JSON */}
              {activeTab === 'json' && (
                <pre className="w-full h-80 p-4 border border-border rounded-md bg-surface text-xs font-mono overflow-auto select-text text-muted">
